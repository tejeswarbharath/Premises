...
import udacity.tour.tejeswar.tourism.PlaceDetailsJSONParser;
import udacity.tour.tejeswar.tourism.PlaceJSONParser;
...

{
    ...
    public static final String AUTHORITY = "udacity.tour.tejeswar.tourism";
